...
public class HospitalDescRes {
    ...
    @Builder
    public HospitalDescRes(int hospitalId, String hospitalName, String hospitalTel, double hospitalStar, String hospitalAdd,
                           int hospitalParking, String hospitalDevice, String hospitalSpecial, List<String> hospitalPartName, List<Integer> hospitalPartDoctor) {
